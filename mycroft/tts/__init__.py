...
class TTS(metaclass=ABCMeta):
    ...
    def execute(self, sentence, ident=None, listen=False, message=None):
        ...
        # TODO: Server support intersects multi-language output here. Will address in separate PR DM
        # multi lang support
        ...
        try:
            self._execute(sentence, ident, listen, user_lang, message)
        except Exception:
    ...
    def _execute(self, sentence, ident, listen, lang, message):
